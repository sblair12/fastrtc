...
var za = [
  ...
  if (r === "textord") {
    ...
    if (S === "ams") {
      ...
      return h0(i, b, a, t, l.concat(t.fontWeight, t.fontShape));
    } else {
      var y = Ia(S, t.fontWeight, t.fontShape);
      return h0(i, y, a, t, l.concat(y, t.fontWeight, t.fontShape));
    }
  } else
...
var P = {
  ...
  function r() {
    ...
    if (ee.contains(["widehat", "widecheck", "widetilde", "utilde"], o)) {
      ...
      var A = [], b = Fd[o], [y, E, x] = b, T = x / 1e3, z = y.length, I, B;
      if (z === 1) {
        var R = b[3];
        I = ["hide-tail"], B = [R];
      } else if (z === 2)
...
var On = function(e, t, r) {
  ...
  var v = On(s, p, i), w = v.height + v.depth, S = On(c, p, i), A = S.height + S.depth, b = On(h, p, i), y = b.height + b.depth, E = 0, x = 1;
  if (o !== null) {
    var T = On(o, p, i);
    E = T.height + T.depth, x = 2;
  }
  var z = w + y + E, I = Math.max(0, Math.ceil((t - z) / (x * A))), B = z + I * x * A, R = a.fontMetrics().axisHeight;
  r && (R *= a.sizeMultiplier);
  var L = B / 2 - R, W = [];
  if (m.length > 0) {
    var oe = B - w - y, q = Math.round(B * 1e3), ue = Q2(m, Math.round(oe * 1e3)), ie = new Lr(m, ue), we = (f / 1e3).toFixed(3) + "em", de = (q / 1e3).toFixed(3) + "em", ke = new vr([ie], {
      width: we,
      height: de,
      viewBox: "0 0 " + f + " " + q
...
var I0 = function(e, t) {
  ...
  for (
    ...
    for (var ae = oe[ie] || {}, me = !0; ae.type === "separator"; ) {
      if (me || (ue = M.makeSpan(["arraycolsep"], []), ue.style.width = G(t.fontMetrics().doubleRuleSep), q.push(ue)), ae.separator === "|" || ae.separator === ":") {
    ...
    if (!(a >= s)) {
      var ve = void 0;
      (a > 0 || e.hskipBeforeAndAfter) && (ve = ee.deflt(ae.pregap, f), ve !== 0 && (ue = M.makeSpan(["arraycolsep"], []), ue.style.width = G(ve), q.push(ue)));
      var _e = [];
      for (r = 0; r < i; ++r) {
        var Se = o[r], Be = Se[a];
        if (Be) {
      ...
      _e = M.makeVList({
        positionType: "individualShift",
        children: _e
      }, t), _e = M.makeSpan(["col-align-" + (ae.align || "c")], [_e]), q.push(_e), (a < s - 1 || e.hskipBeforeAndAfter) && (ve = ee.deflt(ae.postgap, f), ve !== 0 && (ue = M.makeSpan(["arraycolsep"], []), ue.style.width = G(ve), q.push(ue)));
    }
  }
...
Pr({
  ...
  htmlBuilder(n, e) {
    ...
    if (o) {
      ...
      (l instanceof B0 || y) && (b = G(-l.italic));
    }
    var E;
    if (s && o) {
...
`, e = e.substring(f.length + 1), h = !0), !h) {
          ...
          for (; e; ) {
            const x = e.split(`
`, 1)[0];
            if (f = x, this.options.pedantic && (f = f.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")), y.test(f) || E.test(f) || A.test(f) || b.test(e))
              break;
...
(function(n) {
  ...
  var t = function(r) {
    var a = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, l = {}, s = {
        ...
        clone: function b(y, E) {
          ...
          switch (s.util.type(y)) {
            case "Object":
              ...
              {}, E[T] = x;
              for (var z in y)
                y.hasOwnProperty(z) && (x[z] = b(y[z], E));
              return (
                /** @type {any} */
                x
              );
            case "Array":
              return T = s.util.objId(y), E[T] ? E[T] : (x = [], E[T] = x, /** @type {Array} */
              /** @type {any} */
      ...
      languages: {
        ...
        insertBefore: function(b, y, E, x) {
          ...
          var R = x[b];
          return x[b] = z, s.languages.DFS(s.languages, function(L, W) {
            W === R && L != b && (this[L] = z);
          }), z;
        },
        // Traverse a language definition with Depth First Search
        DFS: function b(y, E, x, T) {
          T = T || {};
          var z = s.util.objId;
          for (var I in y)
      ...
      highlightAllUnder: function(b, y, E) {
        ...
        for (var T = 0, z; z = x.elements[T++]; )
          s.highlightElement(z, y === !0, x.callback);
      },
      /**
      ...
      highlightElement: function(b, y, E) {
        var x = s.util.getLanguage(b), T = s.languages[x];
        s.util.setLanguage(b, x);
    ...
    r.Prism = s;
    function o(b, y, E, x) {
      this.type = b, this.content = y, this.alias = E, this.length = (x || "").length | 0;
    }
      ...
      for (var I in E)
        if (!(!E.hasOwnProperty(I) || !E[I])) {
          ...
          for (var R = 0; R < B.length; ++R) {
            ...
            for (var we = L.pattern || L, de = x.next, ke = T; de !== y.tail && !(z && ke >= z.reach); ke += de.value.length, de = de.next) {
              var De = de.value;
              ...
              if (!(De instanceof o)) {
                ...
                if (q) {
                  if (ae = c(we, ke, b, oe), !ae || ae.index >= b.length)
                    break;
                  var U = ae.index, me = ae.index + ae[0].length, Le = ke;
                  for (Le += de.value.length; U >= Le; )
                    de = de.next, Le += de.value.length;
                  if (Le -= de.value.length, ke = Le, de.value instanceof o)
                    continue;
                  for (var H = de; H !== y.tail && (Le < me || typeof H.value == "string"); H = H.next)
                    te++, Le += H.value.length;
                  te--, De = b.slice(ke, Le), ae.index -= ke;
                } else if (ae = c(we, 0, De, oe), !ae)
                  continue;
                var U = ae.index, ve = ae[0], _e = De.slice(0, U), Se = De.slice(U + ve.length), Be = ke + De.length;
                z && Be > z.reach && (z.reach = Be);
                var Ie = de.prev;
                _e && (Ie = f(y, Ie, _e), ke += _e.length), p(y, Ie, te);
                var Ye = new o(I, W ? s.tokenize(ve, W) : ve, ue, ve);
                if (de = f(y, Ie, Ye), Se && f(y, de, Se), te > 1) {
                  var ct = {
                    cause: I + "," + R,
                    reach: Be
                  };
                  h(b, y, E, de.prev, ke, ct), z && ct.reach > z.reach && (z.reach = ct.reach);
                }
              }
            }
          }
    ...
    function f(b, y, E) {
      var x = y.next, T = { value: E, prev: y, next: x };
      return y.next = T, x.prev = T, b.length++, T;
    }
    function p(b, y, E) {
      for (var x = y.next, T = 0; T < E && x !== b.tail; T++)
        x = x.next;
      y.next = x, x.prev = y, b.length -= T;
    }
    function v(b) {
    ...
    if (!r.document)
      return r.addEventListener && (s.disableWorkerMessageHandler || r.addEventListener("message", function(b) {
        var y = JSON.parse(b.data), E = y.language, x = y.code, T = y.immediateClose;
...
function xu(n, e = {}) {
  ...
  function v(S, A = {}) {
    ...
    return n == null || A.hard || w.stiffness >= 1 && w.damping >= 1 ? (p = !0, l = Su(), c = S, t.set(n = h), Promise.resolve()) : (A.soft && (f = 1 / ((A.soft === !0 ? 0.5 : +A.soft) * 60), m = 0), s || (l = Su(), p = !1, s = e5((y) => {
      ...
      return l = y, c = n, t.set(n = x), E.settled && (s = null), !E.settled;
    })), new Promise((y) => {
      s.promise.then(() => {
        b === o && y();
      });
...
function c5(n, e, t) {
  ...
  var i = this && this.__awaiter || function(p, v, w, S) {
    ...
    return new (w || (w = Promise))(function(b, y) {
      ...
      function T(z) {
        z.done ? b(z.value) : A(z.value).then(E, x);
      }
...
function w5(n) {
  ...
  return {
    c() {
      h && h.c(), e = $t(), t = x0("div"), p && p.c(), r = $t(), v && v.c(), a = $t(), l && l.c(), s = $t(), b && b.c(), o = r0(), this.h();
    },
    l(y) {
      h && h.l(y), e = Jt(y), t = F0(y, "DIV", { class: !0 });
      var E = S0(t);
      p && p.l(E), r = Jt(E), v && v.l(E), E.forEach(Q), a = Jt(y), l && l.l(y), s = Jt(y), b && b.l(y), o = r0(), this.h();
    },
    h() {
    ...
    p(y, E) {
      ...
      let x = i;
      i = A(y), i === x ? ~i && S[i].p(y, E) : (l && (cs(), C0(S[x], 1, 1, () => {
        S[x] = null;
      }), us()), ~i ? (l = S[i], l ? l.p(y, E) : (l = S[i] = w[i](y), l.c()), d0(l, 1), l.m(s.parentNode, s)) : l = null), /*timer*/
      y[5] ? b && (cs(), C0(b, 1, 1, () => {
        b = null;
      }), us()) : b ? (b.p(y, E), E[0] & /*timer*/
      32 && d0(b, 1)) : (b = Yu(y), b.c(), d0(b, 1), b.m(o.parentNode, o));
    },
    i(y) {
      c || (d0(l), d0(b), c = !0);
    },
...
function rh() {
  ...
  })), U = null, ve = null, _e = !0, Se = !0, Be = !1, Ie = !0, Ye = !1, ct = !0, Xe = !1, Ue = !1, Ge = !1, j = !1, N = !1, le = !1, R0 = !0, fa = !1;
  ...
  const Sh = t.createElement("form"), lo = function(C) {
    ...
    if (!(Xr && Xr === C)) {
      ...
      Ah.indexOf(C.PARSER_MEDIA_TYPE) === -1 ? Eh : C.PARSER_MEDIA_TYPE, it = vn === "application/xhtml+xml" ? Ml : Qa, te = c0(C, "ALLOWED_TAGS") ? pe({}, C.ALLOWED_TAGS, it) : ae, me = c0(C, "ALLOWED_ATTR") ? pe({}, C.ALLOWED_ATTR, it) : Le, Vi = c0(C, "ALLOWED_NAMESPACES") ? pe({}, C.ALLOWED_NAMESPACES, Ml) : Dh, Pi = c0(C, "ADD_URI_SAFE_ATTR") ? pe(
        Tr(io),
    ...
    return C instanceof o && !xh(C) || (Z === "noscript" || Z === "noembed" || Z === "noframes") && Et(/<\/no(script|embed|frames)/i, C.innerHTML) ? (v0(C), !0) : (Ye && C.nodeType === Nn.text && (V = C.textContent, Ha([W, oe, q], (Te) => {
      V = Bn(V, Te, " ");
...
function K6(n, e, t) {
  ...
  function A() {
    ...
    const y = Array.from(f).reduce((E, x) => E + x, 0) / f.length / 255;
...
function c7(n) {
  ...
  return {
    ...
    l(S) {
      ...
      var b = _t(t);
      a.l(b), b.forEach(Ee), i = T0(A), v && v.l(A), A.forEach(Ee), l = T0(S), w && w.l(S), s = mi(), this.h();
    },
    h() {
...
function b7(n, e, t) {
  ...
  function de() {
    return r(this, void 0, void 0, function* () {
      if (c === "closed") {
        ie = new RTCPeerConnection(x), ie.addEventListener("connectionstatechange", (ve) => r(this, void 0, void 0, function* () {
        ...
        Bi(q, ie, f === "send" ? null : a, z.offer, we, "video", oe, p, void 0, m).then((ve) => {
          clearTimeout(U), ie = ve;
        }).catch(() => {
...
function N7(n, e, t) {
  ...
  } } = e, { stream_handler: h } = e, { time_limit: m = null } = e, { button_labels: f } = e, { server: p } = e, { rtc_configuration: v } = e, { track_constraints: w = {} } = e, { mode: S } = e, { on_change_cb: A } = e, { reject_cb: b } = e, { rtp_params: y = {} } = e, { icon: E = void 0 } = e, { icon_button_color: x = "var(--color-accent)" } = e, { pulse_color: T = "var(--color-accent)" } = e, { icon_radius: z = 50 } = e;
  const I = B7();
  function B(q) {
    r = q, t(0, r);
  }
  ...
  return n.$$set = (q) => {
    "value" in q && t(0, r = q.value), "label" in q && t(1, a = q.label), "show_label" in q && t(2, i = q.show_label), "include_audio" in q && t(3, l = q.include_audio), "i18n" in q && t(4, s = q.i18n), "active_source" in q && t(18, o = q.active_source), "handle_reset_value" in q && t(19, c = q.handle_reset_value), "stream_handler" in q && t(20, h = q.stream_handler), "time_limit" in q && t(5, m = q.time_limit), "button_labels" in q && t(6, f = q.button_labels), "server" in q && t(7, p = q.server), "rtc_configuration" in q && t(8, v = q.rtc_configuration), "track_constraints" in q && t(9, w = q.track_constraints), "mode" in q && t(10, S = q.mode), "on_change_cb" in q && t(11, A = q.on_change_cb), "reject_cb" in q && t(12, b = q.reject_cb), "rtp_params" in q && t(13, y = q.rtp_params), "icon" in q && t(14, E = q.icon), "icon_button_color" in q && t(15, x = q.icon_button_color), "pulse_color" in q && t(16, T = q.pulse_color), "icon_radius" in q && t(17, z = q.icon_radius);
  }, I("drag", I7), [
    r,
    a,
    i,
...
function j7(n, e, t) {
  var r = this && this.__awaiter || function(m, f, p, v) {
    ...
    return new (p || (p = Promise))(function(S, A) {
      ...
      function E(x) {
        x.done ? S(x.value) : w(x.value).then(b, y);
      }
...
function y8(n, e, t) {
  ...
  function b() {
    ...
    for (let E = 0; E < y.length; E++) {
      const x = v[E] / 255 * 2;
      y[E].style.transform = `scaleY(${Math.max(0.1, x)})`;
    }
...
function M8(n, e, t) {
  var r = this && this.__awaiter || function(L, W, oe, q) {
    ...
    return new (oe || (oe = Promise))(function(ie, we) {
      ...
      function De(te) {
        te.done ? ie(te.value) : ue(te.value).then(de, ke);
      }
...
function J8(n) {
  ...
  return {
    ...
    m(I, B) {
      Ot(e, I, B), ut(I, t, B), Ot(r, I, B), ut(I, a, B), ut(I, i, B), We(i, l), b[s].m(l, null), We(i, c), E && E.m(i, null), We(i, h), x && x.m(i, null), We(i, m), T && T.m(i, null), We(i, p), z && z.m(i, null), v = !0, w || (S = Q0(
        l,
        "click",
        /*start_stream*/
        n[25]
    ...
    p(I, B) {
      ...
      s = y(I), s === W ? b[s].p(I, B) : (U0(), Ae(b[W], 1, 1, () => {
        b[W] = null;
      }), V0(), o = b[s], o ? o.p(I, B) : (o = b[s] = A[s](I), o.c()), ge(o, 1), o.m(l, null)), /*stream_state*/
    ...
    d(I) {
      I && (he(t), he(a), he(i)), Lt(e, I), Lt(r, I), b[s].d(), E && E.d(), x && x.d(), T && T.d(), z && z.d(), w = !1, S();
    }
  };
}
function $8(n) {
...
function dp(n, e, t) {
  var r = this && this.__awaiter || function(j, N, le, R0) {
    function fa(Er) {
  ...
  }, I = !1, B = null, { server: R } = e, L = "closed", W, oe, q = null, ue, ie, we = null, de = !1, ke = !1, De = !1;
  ...
  function me() {
    return r(this, void 0, void 0, function* () {
      ...
      t(17, ie = dh(yield fh(), "audioinput")), t(19, de = !0);
  ...
  function Le() {
    return r(this, void 0, void 0, function* () {
      if (L === "open") {
        zt(oe), t(14, L = "closed"), t(13, B = null), yield me();
        return;
      }
  ...
  const U = (j) => r(void 0, void 0, void 0, function* () {
    ...
    })), t(18, we = ie.find((R0) => R0.deviceId === le) || null), t(12, I = !1);
  });
  function ve() {
  ...
  const Ie = () => ae("stop"), Ye = () => ae("play"), ct = async () => me(), Xe = () => ue, Ue = () => t(12, I = !0), Ge = () => t(12, I = !1);
  return n.$$set = (j) => {
...
function Bp(n, e, t) {
  ...
  const oe = (N) => {
    ...
    var le;
    N.status === "failed" && ((le = N.meta) === null || le === void 0 ? void 0 : le.error) === "concurrency_limit_reached" ? b.dispatch("error", "Too many concurrent connections. Please try again later!") : b.dispatch("error", "Unexpected server error");
  }, ue = () => b.dispatch("clear_status", m);
  function ie(N) {
    l = N, t(0, l);
  }
  const we = () => b.dispatch("tick"), de = ({ detail: N }) => b.dispatch("error", N);
  function ke(N) {
    l = N, t(0, l);
  }
  ...
  const Le = () => b.dispatch("clear"), H = () => b.dispatch("play"), U = () => b.dispatch("pause"), ve = () => b.dispatch("upload"), _e = () => b.dispatch("stop"), Se = () => b.dispatch("end"), Be = () => b.dispatch("start_recording"), Ie = () => b.dispatch("stop_recording"), Ye = () => b.dispatch("tick"), ct = ({ detail: N }) => b.dispatch("error", N);
  function Xe(N) {
    l = N, t(0, l);
  }
